...
public class SelesaiFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getDataHistorySelesai();
        return view;
    }

    private void getDataHistorySelesai() {
        ...
        int status = 4;
        retrofit2.Call<ResponseGetBooking> getBookingSelesaiCall = api.getBooking(
                status,
                idUser,
                token,
                device
        );
        getBookingSelesaiCall.enqueue(new Callback<ResponseGetBooking>() {
            @Override
